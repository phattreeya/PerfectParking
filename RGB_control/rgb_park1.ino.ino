...
#define FIREBASE_AUTH "IK9SGS2odR4rtsuxOGY14eVSkqQ11v8AK6VW6Cos" //Database Secret Key (หาได้จาก - เฟือง > Project Settings > Service accounts > Database Secrets)
...
void loop(){
    //Firebase.setInt("led");
    int car_distance = Firebase.getInt("Park_1/S");
    if(car_distance <= 30){
      digitalWrite(D0,LOW);
